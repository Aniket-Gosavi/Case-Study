...
public class UserControllerTest {
    ...
    public void testFindBySourceAndDestination() throws ResourceNotFoundException {
        ...
        when(bookingService.showBySourceAndDestination(source, destination)).thenReturn(trainDetailsList);

        ResponseEntity<?> response = userController.findBySourceAndDestination(source, destination);
